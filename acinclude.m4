dnl acinclude.m4 - configure macros used by aurman
...
dnl are some aurman specific macros at the end of the file as well.
...
dnl Add some custom macros for aurman
